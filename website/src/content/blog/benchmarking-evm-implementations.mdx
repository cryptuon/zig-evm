...
Explore opcode-level execution behavior in the [Zig EVM Playground](/playground/), or dive into the source code at [github.com/cryptuon/zig-evm](https://github.com/cryptuon/zig-evm).
