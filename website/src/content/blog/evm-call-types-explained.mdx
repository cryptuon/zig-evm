...
You can experiment with bytecode-level call sequences in the [Zig EVM Playground](/zig-evm/playground/), stepping through each opcode to observe how `msg.sender`, storage context, and return data change depending on the call type.
...
- [EVM Opcodes Explained](/zig-evm/blog/evm-opcodes-explained/) -- our comprehensive opcode reference
