...
For a deep dive into DELEGATECALL mechanics and the proxy pattern, see our [EVM Call Types Explained](/zig-evm/blog/evm-call-types-explained/) guide.
...
Try stepping through vulnerable patterns in the [Zig EVM Playground](/zig-evm/playground/) to see exactly how reentrancy exploits work at the opcode level.
...
- [EVM Call Types Explained](/zig-evm/blog/evm-call-types-explained/) -- deep dive into CALL, DELEGATECALL, and STATICCALL
- [EVM Opcodes Explained](/zig-evm/blog/evm-opcodes-explained/) -- complete opcode reference
- [How the EVM Works](/zig-evm/blog/how-evm-works/) -- foundational EVM architecture
- [Zig EVM on GitHub](https://github.com/cryptuon/zig-evm) -- explore the source code
- [Zig EVM Playground](/zig-evm/playground/) -- test bytecode interactively
