...
You can step through SLOAD and SSTORE execution in the [Zig EVM Playground](/playground/) to see exactly how the stack and storage interact.
...
The [Zig EVM project](https://github.com/cryptuon/zig-evm) implements storage as a HashMap-based key-value store, closely mirroring the EVM specification. You can observe storage operations at the opcode level using the [Zig EVM Playground](/playground/):
