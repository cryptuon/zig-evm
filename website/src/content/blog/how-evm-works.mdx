...
For a comprehensive treatment of gas costs and optimization strategies, see our guide on [Understanding EVM Gas](/zig-evm/blog/understanding-evm-gas/).
...
The optimized parallel executor achieves 5-6x throughput improvement for realistic transaction batches. You can experiment with this in the [Zig EVM Playground](/zig-evm/playground/) or run the benchmarks from the [source repository](https://github.com/cryptuon/zig-evm).
...
- For a detailed look at individual instructions, see our [EVM Opcodes Reference](/zig-evm/blog/evm-opcodes-explained/).
- Learn about [EVM Gas Costs](/zig-evm/blog/understanding-evm-gas/) to understand how the EVM prices each operation.
- Explore [Parallel EVM Execution](/zig-evm/blog/parallel-evm-execution/) to see how transaction throughput can be improved 5-6x.
- Understand [EVM Storage Layout](/zig-evm/blog/evm-storage-layout-explained/) to see how Solidity maps variables to the persistent key-value store.
- Read about [EVM Security Vulnerabilities](/zig-evm/blog/evm-security-vulnerabilities-guide/) to learn what can go wrong in smart contract execution.
