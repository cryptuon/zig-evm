...
You can benchmark the Zig EVM yourself by cloning the [repository](https://github.com/cryptuon/zig-evm) and running `zig build benchmark`, or try individual opcodes in the [Playground](/zig-evm/playground/).
...
- Try the implementation in the [Zig EVM Playground](/zig-evm/playground/) or explore the full source on [GitHub](https://github.com/cryptuon/zig-evm).
